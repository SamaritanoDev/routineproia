...
import 'package:routineproia/src/features/generate_routine/presentation/screens/generate_routine_screen.dart';
...
class __FormersonalizationRoutineState
  ...
  CustomRoutineModel userSelection = CustomRoutineModel(
    idContentOptions: '',
    exerciseGoal: [],
    experienceLevel: [],
  ...
  void _submitForm() async {
    ...
    final userRoutine = userSelection.toJson();
    final callPromt = GeneratedRoutineInstruction();

    try {
      final List<Routine> routines =
          await callPromt.generatedDataRoutine(userRoutine);
      setState(() {
        isLoading = false;
      });
      ...
      print("Error al obtener la rutina personalizada: $e");
    }
  }
}
